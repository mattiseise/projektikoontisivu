...
window.NAYTTOPROJEKTI = {
  ...
  viikkoOhjeet: {
    ...
    46: {
      ...
      done: "A beginner can find 'thank you' by typing 'thank' on the public URL, the dialogues toggle between languages, searching for the T10 attack string (the img-onerror line in the test matrix) renders as harmless text, and the full test matrix (≥12 cases) exists with expected results filled in.",
